 ...
 * -----------------------------------------------------------------
 * 2014/9/25 : 创建 Times (JiongBull);
 * -----------------------------------------------------------------
 */
package com.kevin.volleygson.constants;
...
public class Times {
     ...
     * 加载对话框延迟关闭时间.
     */
    public static final long LOADING_DIALOG_DISMISS_DELAY = 500;
     ...
     * 下拉刷新延迟时间.
     */
    public static final long SWIPE_LOADING_DELAY = 500;

    /**
     * 输入法延迟显示时间.
     */
    public static final long IMM_DELAY = 100;
}
